...
If your bundler recognizes `browser` field of `package.json`, the imported `AbortController` is the native one and it doesn***REMOVED***t contain shim (even if the native implementation was nothing).
