...
const Speaking = require(***REMOVED***../../../util/Speaking***REMOVED***);
const secretbox = require(***REMOVED***../util/Secretbox***REMOVED***);
const { SILENCE_FRAME } = require(***REMOVED***../util/Silence***REMOVED***);

// The delay between packets when a user is considered to have stopped speaking
// https://github.com/discordjs/discord.js/issues/3524#issuecomment-540373200
const DISCORD_SPEAKING_DELAY = 250;

class Readable extends require(***REMOVED***stream***REMOVED***).Readable {
...
class PacketHandler extends EventEmitter {
  ...
  _stoppedSpeaking(userID) {
    ...
    if (streamInfo && streamInfo.end === ***REMOVED***silence***REMOVED***) {
  ...
  makeStream(user, end) {
    ...
    stream.on(***REMOVED***end***REMOVED***, () => this.streams.delete(user));
  ...
  parseBuffer(buffer) {
    ...
    if (!packet) return new Error(***REMOVED***Failed to decrypt voice packet***REMOVED***);
  ...
  push(buffer) {
    ...
    if (userStat.hasVideo) {
      ...
      if (opusPacket instanceof Error) {
        ...
        if (streamInfo) {
          this.emit(***REMOVED***error***REMOVED***, opusPacket);
          return;
        }
      }
    ...
    if (typeof speakingTimeout === ***REMOVED***undefined***REMOVED***) {
      // Ensure at least the speaking bit is set.
      // As the object is by reference, it***REMOVED***s only needed once per client re-connect.
