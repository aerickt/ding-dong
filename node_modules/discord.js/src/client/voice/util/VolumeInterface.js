...
class VolumeInterface extends EventEmitter {
  ...
  setVolume(volume) {
     ...
     */
    this.emit(***REMOVED***volumeChange***REMOVED***, this._volume, volume);
    this._volume = volume;
  }
...
const props = [***REMOVED***volumeDecibels***REMOVED***, ***REMOVED***volumeLogarithmic***REMOVED***, ***REMOVED***setVolumeDecibels***REMOVED***, ***REMOVED***setVolumeLogarithmic***REMOVED***];
