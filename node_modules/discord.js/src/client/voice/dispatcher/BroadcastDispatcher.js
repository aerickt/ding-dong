...
const StreamDispatcher = require(***REMOVED***./StreamDispatcher***REMOVED***);
...
class BroadcastDispatcher extends StreamDispatcher {
   ...
   * If set to ***REMOVED***auto***REMOVED***, 48kbps will be used
  ...
  setBitrate(value) {
    ...
    const bitrate = value === ***REMOVED***auto***REMOVED*** ? 48 : value;
