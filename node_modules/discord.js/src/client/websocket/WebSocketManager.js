...
const WebSocketShard = require(***REMOVED***./WebSocketShard***REMOVED***);
const PacketHandlers = require(***REMOVED***./handlers***REMOVED***);
const { Error: DJSError } = require(***REMOVED***../../errors***REMOVED***);
const Collection = require(***REMOVED***../../util/Collection***REMOVED***);
const { Events, ShardEvents, Status, WSCodes, WSEvents } = require(***REMOVED***../../util/Constants***REMOVED***);
