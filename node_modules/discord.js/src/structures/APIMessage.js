...
const MessageEmbed = require(***REMOVED***./MessageEmbed***REMOVED***);
const { RangeError } = require(***REMOVED***../errors***REMOVED***);
...
class APIMessage {
  ...
  get isWebhook() {
    ...
    const WebhookClient = require(***REMOVED***../client/WebhookClient***REMOVED***);
   ...
   */
  get isMessage() {
    const Message = require(***REMOVED***./Message***REMOVED***);
