...
declare class Collection<K, V> extends Map<K, V> {
    ...
    [***REMOVED***constructor***REMOVED***]: typeof Collection;
     ...
     * @returns {*}
     * @example collection.find(user => user.username === ***REMOVED***Bob***REMOVED***);
     */
     ...
     * @param {*} [thisArg] Value to use as `this` when executing function
     * @returns {*}
     * @example collection.findKey(user => user.username === ***REMOVED***Bob***REMOVED***);
     */
     ...
     * @param {*} [thisArg] Value to use as `this` when executing function
     * @returns {Collection}
     * @example collection.filter(user => user.username === ***REMOVED***Bob***REMOVED***);
     */
     ...
     * @param {*} [thisArg] Value to use as `this` when executing function
     * @returns {boolean}
     * @example collection.some(user => user.discriminator === ***REMOVED***0000***REMOVED***);
     */
