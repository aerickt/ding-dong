...
fs.createReadStream(***REMOVED***./audio.ogg***REMOVED***)
  .pipe(new prism.opus.OggDemuxer())
  .pipe(new prism.opus.Decoder({ rate: 48000, channels: 2, frameSize: 960 }))
  .pipe(fs.createWriteStream(***REMOVED***./audio.pcm***REMOVED***));
```

The example above can work with either a native or pure JavaScript Opus decoder - you don***REMOVED***t need to worry about changing
