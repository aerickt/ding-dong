...
objects are still `Uint8Array`s, so if you need `Buffer`s, you***REMOVED***ll have to
...
Encrypts and authenticates message using peer***REMOVED***s public key, our secret key, and
...
Authenticates and decrypts the given box with peer***REMOVED***s public key, our secret
...
If the platform doesn***REMOVED***t provide a suitable PRNG, the following functions,
...
If a platform you are targeting doesn***REMOVED***t implement secure random number
